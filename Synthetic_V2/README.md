...
This directory contains version 2 of the synthetic DICOM de-identification dataset, including pixel PHI, PDF-encapsulated DICOM files, metadata PHI, and ground truth annotations. The version 1 dataset is available in the `Presidio/` directory.
...
The downloaded dataset is organized by original inputs. The notebooks write de-identified outputs under `data/deid/`.
...
| `data/deid/dicom/pixel/` | De-identified pixel DICOM outputs generated by the pixel notebook. |
| `data/deid/dicom/pdf/` | De-identified PDF-encapsulated DICOM outputs generated by the PDF notebook. |
| `data/deid/image/pixel/` | Rendered de-identified pixel outputs generated by the pixel notebook. |
| `data/deid/image/pdf/` | Rendered de-identified PDF outputs generated by the PDF notebook. |
